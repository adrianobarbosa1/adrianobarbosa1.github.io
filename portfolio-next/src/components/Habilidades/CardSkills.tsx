...
const CardSkills = ({ Icon, title, desc }: CardSkillsProps) => {
  return (
    <div className="flex flex-col items-center text-center h-[450px] bg-gray-300 dark:bg-[#242424] p-3">
      ...
      <div>
        ...
        <p className="mt-5 p-2 text-base md:text-sm dark:text-darkTexto">
          {desc}
        </p>
      </div>
    </div>
